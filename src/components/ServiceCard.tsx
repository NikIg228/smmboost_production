...
export const ServiceCard: React.FC<ServiceCardProps> = ({ service, onServiceClick }) => {
  ...
  return (
    <div className="group relative glass-effect rounded-xl border border-gray-700/50 hover:border-purple-500/50 transition-all duration-500 overflow-hidden card-hover glow-effect">
      ...
      <div className="relative z-10 p-4 sm:p-6">
        ...
        <button
          ...
          className="w-full py-2.5 sm:py-3 text-sm sm:text-base bg-gradient-to-r from-pink-500 to-purple-600 text-white font-semibold rounded-lg hover:from-pink-600 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-pink-500/25 button-hover-lift glow-effect neon-button"
        >
          Купить
        </button>
      </div>
